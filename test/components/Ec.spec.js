...
import Ec from '../../app/components/Ec';
...
function setup() {
  ...
  //   decrement: spy()
  // };
  const component = shallow(<Ec /*counter={1} {...actions}*/ />);
  return {
    component,
    //actions,
...
describe('Ec component', () => {
  ...
  it('should match exact snapshot', () => {
    ...
    const ec = (
      <div>
        <Router>
          <Ec /*counter={1} {...actions}*/ />
        </Router>
      </div>
    );
    const tree = renderer.create(ec).toJSON();
